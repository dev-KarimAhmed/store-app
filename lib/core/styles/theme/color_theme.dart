...
class MyColors extends ThemeExtension<MyColors> {
  ...
  static const MyColors light = MyColors(
    mainColor: LighColors.mainColor,
    bluePinkDark: LighColors.pinkDark,
    bluePinkLight: LighColors.pinkLight,
    textColor: LighColors.black,
    textFormBorder: LighColors.pinkLight,
    navBarbg: LighColors.mainColor,
    navBarSelectedTab: LighColors.pinkDark,
    containerShadow1: LighColors.white,
    containerShadow2: LighColors.white,
    containerLinear1: LighColors.pinkDark,
    containerLinear2: LighColors.pinkLight,
  );
}
